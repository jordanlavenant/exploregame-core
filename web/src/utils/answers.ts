...
interface SaveAnswersProps {
  ...
  createAnswer: (variables: { variables: { input: { answer: string, description: string, isCorrect: boolean, questionId: string } } }) => void
}

export const saveAnswers = async ({ currentAnswers, question, deleteAnswer, createAnswer } : SaveAnswersProps) => {
